...
class BlockingConcurrentQueue {
 private:
  using ConcurrentQueue = ::ncaf::embedded_3rd::moodycamel::ConcurrentQueue<T, Traits>;
  using LightweightSemaphore = ::ncaf::embedded_3rd::moodycamel::LightweightSemaphore;
 ...
 public:
  ...
  inline size_t wait_dequeue_bulk_timed(It itemFirst, size_t max, std::chrono::duration<Rep, Period> const& timeout) {
    return wait_dequeue_bulk_timed<It&>(itemFirst, max,
  ...
  inline size_t wait_dequeue_bulk_timed(consumer_token_t& token, It itemFirst, size_t max,
    ...
    return wait_dequeue_bulk_timed<It&>(token, itemFirst, max,
                                        std::chrono::duration_cast<std::chrono::microseconds>(timeout).count());
  }
